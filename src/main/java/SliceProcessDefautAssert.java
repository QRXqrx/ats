...
public class SliceProcessDefautAssert {
    ...
    public static void run(String[] args) {
        ...
        try {
            ...
            System.out.println("In SliceProcessDefautAssert@run(), load settings failed: " + settingPath);
            e.printStackTrace();
            System.exit(-1);
        }
    ...
    private static List<AtomTestCase> makeSlice(
        ...
        try {
            ...
            System.out.println("In SliceProcessDefautAssert@makeSlice, getDynamicScope failed: " + classDir);
            e.printStackTrace();
            System.exit(-1);
        }
    ...
    private static void outputToFile(String outputDir, String outputFileName , List<AtomTestCase> atomTestCases) {
        ...
        try {
            ...
            System.out.println("In SliceProcessDefautAssert@outputToFile, write to file failed: " + absFilePath);
            e.printStackTrace();
            System.exit(-1);
        }
    }
